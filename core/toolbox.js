...
Blockly.Toolbox.prototype.init = function() {
  ...
  this.createFlyout_();
  this.categoryMenu_ = new Blockly.Toolbox.CategoryMenu(this, this.HtmlDiv, workspace.options);
...
Blockly.Toolbox.prototype.createFlyout_ = function() {
  ...
  var options = {
    ...
    blockCategories: workspace.options.blockCategories
  };
 ...
 * @constructor
 */
Blockly.Toolbox.CategoryMenu = function(parent, parentHtml, options = {}) {
  this.parent_ = parent;
  this.height_ = 0;
